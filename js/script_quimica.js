...
let preguntas = ["quimica2.jpg", "quimica3.jpg", "quimica4.jpg", "quimica5.jpg", "quimica6.jpg"];

//arreglo que guardará la opción correcta
let correcta = [1,2,0,1,1];

//arreglo que guardara los paises a mostrar en cada jugada
let opciones = [];
//cargo en el arreglo opciones las opciones a mostrar en cada jugada
opciones.push(["4","5", "6"]);
opciones.push(["I y II","solo I", "solo II"]);
opciones.push(["3","9", "4"]);
opciones.push(["El oxigeno es el agente reductor","El agua es la forma reducida", "El amoniaco es el agente oxidante"]);
opciones.push(["NH^4-","NH^4+", "OH^-1"]);
