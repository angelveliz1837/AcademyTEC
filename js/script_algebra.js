...
let preguntas = ["algebra2.jpg", "algebra3.jpg", "algebra4.jpg", "algebra5.jpg", "algebra6.jpg"];

//arreglo que guardará la opción correcta
let correcta = [0,2,1,0,0];

//arreglo que guardara los paises a mostrar en cada jugada
let opciones = [];
//cargo en el arreglo opciones las opciones a mostrar en cada jugada
opciones.push(["[-3,-1] U {12}","[-3,-1]", "{12}"]);
opciones.push(["<-2,-1]","<1,3]", "<-2,-1] U <1,3]"]);
opciones.push(["6","7", "8"]);
opciones.push(["475","480", "430"]);
opciones.push(["24","27", "28"]);
