...
let preguntas = ["aritmetica2.jpg", "aritmetica3.jpg", "aritmetica4.jpg", "aritmetica5.jpg", "aritmetica6.jpg"];

//arreglo que guardará la opción correcta
let correcta = [0,2,0,1,1];

//arreglo que guardara los paises a mostrar en cada jugada
let opciones = [];
//cargo en el arreglo opciones las opciones a mostrar en cada jugada
opciones.push(["2347 base 9","2300 base 9", "2437 base 9"]);
opciones.push(["8","10", "11"]);
opciones.push(["5","9", "4"]);
opciones.push(["21","22", "20"]);
opciones.push(["1240 soles","1104 soles", "1100 soles"]);
