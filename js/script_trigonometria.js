...
let preguntas = ["trigonometria2.jpg", "trigonometria3.jpg", "trigonometria4.jpg", "trigonometria5.jpg", "trigonometria6.jpg"];

//arreglo que guardará la opción correcta
let correcta = [0,1,2,2,1];

//arreglo que guardara los paises a mostrar en cada jugada
let opciones = [];
//cargo en el arreglo opciones las opciones a mostrar en cada jugada
opciones.push(["sqrt(2)","sqrt(8)", "4"]);
opciones.push(["8°","10°", "9°"]);
opciones.push(["240 u2","210 u2", "216 u2"]);
opciones.push(["4","0", "1"]);
opciones.push(["7/17","-7/17", "0"]);
